const local: App.I18n.Schema = {
  ...
  route: {
    ...
    '/home': 'Trang chủ',
    '/document': 'Tài liệu',
    '/document/element': 'Tài liệu Element Plus',
  ...
  page: {
    ...
    home: {
      ...
      projectNews: {
        ...
        desc1: 'Loic Duong đã tạo dự án mã nguồn mở vue-element-admin vào ngày 28 tháng 5 năm 2024!',
        desc2: 'Loic Duong đã gửi một lỗi cho vue-element-admin, thanh tab đa thẻ không tự động điều chỉnh.',
        desc3: 'Loic Duong đang chuẩn bị cho việc phát hành của vue-element-admin!',
        desc4: 'Loic Duong vừa viết một số tài liệu giới thiệu dự án cho vue-element-admin!',
        desc5: 'Loic Duong vừa viết một số nội dung tạm thời cho trang bàn làm việc của vue-element-admin!',
      },
      creativity: 'Sáng tạo',
    },
    function: {
    ...
    about: {
      title: 'Giới thiệu',
      introduction: `VueElementAdmin là một mẫu quản trị thanh lịch và mạnh mẽ, dựa trên công nghệ front-end mới nhất, bao gồm Vue3, Vite6, TypeScript, Pinia và UnoCSS. Nó có cấu hình chủ đề phong phú và các thành phần tích hợp sẵn, các quy định mã nghiêm ngặt và một hệ thống định tuyến tệp tự động. Ngoài ra, nó cũng sử dụng giải pháp dữ liệu giả trực tuyến dựa trên ApiFox. VueElementAdmin cung cấp cho bạn một giải pháp quản trị một điểm dừng, không cần cấu hình thêm, và sẵn sàng sử dụng. Nó cũng là một phương pháp tốt nhất để học các công nghệ tiên tiến nhanh chóng.`,
      projectInfo: {
