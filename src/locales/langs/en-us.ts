const local: App.I18n.Schema = {
  ...
  route: {
    ...
    '/home': 'Home',
    '/document': 'Document',
    '/document/element': 'Element Plus Document',
  ...
  page: {
    ...
    home: {
      ...
      projectNews: {
        title: 'Project News',
        moreNews: 'More News',
        desc1: 'Loic Duong created the open source project vue-element-admin on May 28, 2024!',
        desc2: 'Loic Duong submitted a bug to vue-element-admin, the multi-tab bar will not adapt.',
        desc3: 'Loic Duong is ready to do sufficient preparation for the release of vue-element-admin!',
        desc4: 'Loic Duong is busy writing project documentation for vue-element-admin!',
    ...
    about: {
      title: 'About',
      introduction: `VueElementAdmin is an elegant and powerful admin template, based on the latest front-end technology stack, including Vue3, Vite6, TypeScript, Pinia and UnoCSS. It has built-in rich theme configuration and components, strict code specifications, and an automated file routing system. In addition, it also uses the online mock data solution based on ApiFox. SoybeanAdmin provides you with a one-stop admin solution, no additional configuration, and out of the box. It is also a best practice for learning cutting-edge technologies quickly.`,
      projectInfo: {
        title: 'Project Info',
        version: 'Version',
