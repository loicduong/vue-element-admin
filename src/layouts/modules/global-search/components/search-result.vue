...
interface Props { options: App.Global.Menu[] }

defineProps<Props>()

interface Emits { (e: 'enter'): void }
...
const handleMouseEnter = (item: App.Global.Menu) => (active.value = item.routePath)

const handleTo = () => (emit('enter'))
</script>
