...
const handleGrayscaleChange = (value: boolean) => (themeStore.setGrayscale(value))

const handleColourWeaknessChange = (value: boolean) => (themeStore.setColourWeakness(value))

const showSiderInverted = computed(() => {
  return !themeStore.darkMode && themeStore.layout.mode.includes('vertical')
})
</script>
